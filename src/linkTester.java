        ...
        while(true) {
            while (cont) {
                ...
                try {
                    ...
                    for (int i = 0; i < titleString.length() - 5; i++) {
                        if (titleString.substring(i, i + 5).equalsIgnoreCase("&#39;"))
                            titleString = (titleString.substring(0, i) + "'" + titleString.substring(i + 5));
                    }
                    ...
                    if (contAsk.equals("yes".toLowerCase())) {
                        ...
                        System.out.print("\nSearch for more videos? (yes/no): ");
                        String contAsk2 = input.nextLine();
                        if (contAsk.equals("yes".toLowerCase())) {
                            cont = true;
                        } else{
                    ...
                    System.out.println("There are " + (links.size()) + " video(s) in the database currently.\n");
                    vidNum++;
                    vidNum2++;
            ...
            if (userInput.equalsIgnoreCase("yes")) {
                ...
                System.out.print("\nLast chance to add videos into the list! (yes/no): ");
                Scanner inputt = new Scanner(System.in);
                String response = inputt.nextLine();
